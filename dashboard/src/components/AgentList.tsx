      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-white/10 pb-6">
        ...
        <div className="flex gap-2">
          <div className="px-3 py-1 bg-emerald-500/10 border border-emerald-500/20 rounded-md">
            <span className="text-[10px] text-emerald-500 font-bold uppercase tracking-wider">Total Agents: {INITIAL_AGENTS.length}</span>
          </div>
          <div className="px-3 py-1 bg-blue-500/10 border border-blue-500/20 rounded-md">
            <span className="text-[10px] text-blue-500 font-bold uppercase tracking-wider">Uptime: 99.98%</span>
          </div>
        </div>
      </div>
